const facts = {
  ...
  pt: {
    ...
    uranus: [
      ...
      // },
      // {
      //   fact: 'Urano é frequentemente chamado de “Gigante Gelado”, por atingir as temperaturas mais baixas de todos os planetas: -224ºC (-435ºF). Tem 13 anéis.',
      // },
      {
    ...
    neptune: [
      ...
      {
        fact: 'Como em Urano, Neptuno pode atingir temperaturas muito baixas, com temperaturas abaixo de -221ºC (-430ºF).',
      },
      {
